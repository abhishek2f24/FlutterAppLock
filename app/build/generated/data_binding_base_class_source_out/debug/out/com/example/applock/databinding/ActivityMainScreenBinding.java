...
public final class ActivityMainScreenBinding implements ViewBinding {
  ...
  private ActivityMainScreenBinding(@NonNull LinearLayout rootView, @NonNull Toolbar toolbar,
  ...
  public static ActivityMainScreenBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityMainScreenBinding((LinearLayout) rootView, toolbar, welcomeText);
    }
